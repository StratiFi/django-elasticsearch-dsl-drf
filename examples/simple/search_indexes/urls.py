...
# *********************** Addresses ************************
# **********************************************************
router.register(r"addresses", AddressDocumentViewSet, basename="addressdocument")
...
# ************************* Authors ************************
# **********************************************************
router.register(r"authors", AuthorDocumentViewSet, basename="authordocument")

# **********************************************************
# ************************* Authors ************************
# **********************************************************
router.register(r"journals", JournalDocumentViewSet, basename="journaldocument")

# **********************************************************
# ************************** Books *************************
# **********************************************************
router.register(r"books", BookDocumentViewSet, basename="bookdocument")
router.register(
    r"books-no-records",
    BookNoRecordsDocumentViewSet,
...
router.register(
    r"books-frontend", BookFrontendDocumentViewSet, basename="bookdocument_frontend"
)
...
router.register(
    r"books-custom", BookCustomDocumentViewSet, basename="bookdocument_custom"
)
...
router.register(r"cities", CityDocumentViewSet, basename="citydocument")
...
router.register(r"locations", LocationDocumentViewSet, basename="locationdocument")

# **********************************************************
# *********************** Publishers ***********************
# **********************************************************

router.register(r"publishers", PublisherDocumentViewSet, basename="publisherdocument")

# *********************************************************
# ************************* Tags **************************
# *********************************************************

router.register(r"tags", TagDocumentViewSet, basename="tagdocument")
